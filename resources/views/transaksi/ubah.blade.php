...
<div class="max-w-xl">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-400 mb-6">
        ...
        <span>/</span>
        <span class="text-gray-700 font-medium">Ubah</span>
    </div>

    <div class="bg-white border border-gray-200 rounded-xl p-8">

        <h2 class="text-base font-semibold text-gray-900 mb-6">Ubah Transaksi</h2>
        ...
        <form method="POST" action="{{ route('transaksi.perbarui', $transaksi->id) }}" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        id="nominal"
                        name="nominal"
                        value="{{ old('nominal', (int) $transaksi->nominal) }}"
                        min="1"
                        step="1"
                        placeholder="0"
                        required
            ...
            <div>
                ...
                >
                    ...
                    @foreach ($kategori as $kat)
                        <option value="{{ $kat->id }}" {{ old('category_id', $transaksi->category_id) == $kat->id ? 'selected' : '' }}>
                            {{ $kat->nama_kategori }}
                        </option>
                    @endforeach
                </select>
